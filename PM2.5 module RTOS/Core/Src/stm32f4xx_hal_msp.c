...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA0-WKUP     ------> ADC1_IN0 
    */
    HAL_GPIO_DeInit(A0_LCD_GPIO_Port, A0_LCD_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA 
    */
    HAL_GPIO_DeInit(GPIOB, RTC_I2C_SCL_Pin|RTC_I2C_SDA_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PA12     ------> USART6_RX 
    */
    HAL_GPIO_DeInit(PM2_5_UART6_TX_GPIO_Port, PM2_5_UART6_TX_Pin);

    HAL_GPIO_DeInit(PM2_5_UART6_RX_GPIO_Port, PM2_5_UART6_RX_Pin);
